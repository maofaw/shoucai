...
网页打开先显示月保守预计，以及未来7天保守和较高两档预计到手利润，再显示下次收菜、买料结论和四台制造建议。月保守预计按周保守预计乘以4.33换算，属于保守估算而非收益保证。买料页会自动省略“一周成本占比不高于3%、30天价格常见波动不高于8%”的便宜稳定材料；这些材料仍计入利润与预算，只是不占用重点清单。设置页可改总账号数、分成账号数、本人分成比例、哈夫币兑换人民币比例和单号买料预算；修改预算后，自动购买天数和7天预算缺口会在当前设备即时重算。普通链接可点击“本轮已完成”，按实际完成时间显示8小时后的下一次收菜；时间只保存在当前浏览器，不会跨设备同步。历史行情证据不足时，页面会标明“临时估算”或“本周没有可靠的首选时段”，不承诺收益。
